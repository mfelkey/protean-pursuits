...
**Version 1.7 | Launch Release | Confidential**

**1 change from commercial API licensing specification. Supersedes PRD v1.6.**

| Field | Detail |
|---|---|
| Product | Parallax — Sports Betting Analytics Platform |
| Version | 1.8 — Launch milestone resequencing + June 11 full-product launch + PDB-01/PDB-02 escalation + explicit sport phasing + affiliate deferral + user_bets discriminator |
| Previous Version | 1.7 — Phase 3 commercial API licensing specification + data re-sale legal risk framework |
| Date | March 2026 |
| Status | ACTIVE — Supersedes v1.0, v1.1, v1.2, v1.3, v1.4, v1.5, v1.6, v1.7 |
...
| New in v1.8 | CHG-45 through CHG-50 — see change log below |
...
> **PRE-DEV BLOCKER PDB-02: World Cup 2026 xG Data Source — Hard Blocker on Soccer Model Training**

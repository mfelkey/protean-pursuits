...
**Version 1.10 | Launch Release | Confidential**

**1 change: PDB-01 closed. Supersedes PRD v1.9.**

| Field | Detail |
|---|---|
| Product | Parallax — Sports Betting Analytics Platform |
| Version | 1.10 — PDB-01 closed: Open-Meteo commercial license obtained. Weather pipeline design authorized. |
| Previous Version | 1.9 — PDB-02 closed: StatsBomb + Understat accepted |
| Date | March 2026 |
| Status | ACTIVE — Supersedes v1.0, v1.1, v1.2, v1.3, v1.4, v1.5, v1.6, v1.7, v1.8, v1.9 |
...
| New in v1.10 | CHG-52 — see change log below |

---

# Change Log — v1.9 to v1.10

One change. PDB-01 closure — weather pipeline design now authorized.

| Change ID | Section | Summary | Priority |
|---|---|---|---|
| CHG-52 | 0.1 / 11.1 | **PDB-01 closed. Open-Meteo commercial license obtained.** Decision date: 2026-03-24. Open-Meteo Forecast API commercial subscription active. weather_snapshots.source set to 'open-meteo-enterprise'. Weather pipeline design is now authorized to begin. DS and Dev teams may proceed with weather data integration against the Forecast API. API key stored in project .env as OPEN_METEO_API_KEY. | Critical |

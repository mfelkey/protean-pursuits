...
def run_devex_documentation(context: dict, prd_path: str = None,
    ...
    # ── Smart extraction: load relevant sections for devex_writer ──
    ctx = load_agent_context(
        context=context,
        consumer="devex_writer",
        artifact_types=["PRD", "TAD", "BIR", "FIR", "DIR", "DSKR"],
...
""",
    ...
    on_artifact_saved(context, "DXR", dxr_path)

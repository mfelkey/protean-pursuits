...
TEAMS = {
    ...
    "finance": {
        ...
        "color":   "#10b981",
        "modes": [
            {"id": "full",       "name": "Full",       "phase": "full",       "produces": "FSP",  "checkpoint": True,  "icon": "📊", "description": "Full Finance sub-crew — CEA → ROI → ICM → BPS → PRI → FSR → SCF → synthesized FSP. CP-4.5 gate fires."},
            {"id": "cost",       "name": "Cost",       "phase": "cost",       "produces": "CEA",  "checkpoint": False, "icon": "💵", "description": "Cost Analyst only — Cost Estimation Analysis"},
            {"id": "roi",        "name": "ROI",        "phase": "roi",        "produces": "ROI",  "checkpoint": False, "icon": "📈", "description": "ROI Analyst only — Return on Investment analysis"},
            {"id": "infra",      "name": "Infra",      "phase": "infra",      "produces": "ICM",  "checkpoint": False, "icon": "🖥️", "description": "Infrastructure Finance Modeler only — Infrastructure Cost Model"},
            {"id": "billing",    "name": "Billing",    "phase": "billing",    "produces": "BPS",  "checkpoint": False, "icon": "💳", "description": "Billing Architect only — Billing & Payments Spec. Skipped if no billing language in PRD."},
            {"id": "pricing",    "name": "Pricing",    "phase": "pricing",    "produces": "PRI",  "checkpoint": False, "icon": "🏷️", "description": "Pricing Specialist only — Pricing & Revenue model. Skipped for internal tool projects."},
            {"id": "statements", "name": "Statements", "phase": "statements", "produces": "FSR",  "checkpoint": False, "icon": "📋", "description": "Financial Statements Modeler only — FSR"},
            {"id": "strategy",   "name": "Strategy",   "phase": "strategy",   "produces": "SCF",  "checkpoint": False, "icon": "♟️", "description": "Strategic Corporate Finance Specialist only — SCF. Always runs last in full mode."},
        ],
        "agents": [
            {"id": "finance_orchestrator",              "name": "Finance Orchestrator",              "tier": "T1", "produces": "FSP", "file": "templates/dev-team/agents/finance/finance_orchestrator.py",    "description": "Sequences crew, cross-checks outputs, synthesises FSP, fires CP-4.5"},
            {"id": "cost_analyst",                      "name": "Cost Analyst",                      "tier": "T1", "produces": "CEA", "file": "templates/dev-team/agents/finance/cost_analyst.py",            "description": "Cost Estimation Analysis — always runs first"},
            {"id": "roi_analyst",                       "name": "ROI Analyst",                       "tier": "T1", "produces": "ROI", "file": "templates/dev-team/agents/finance/roi_analyst.py",             "description": "Return on Investment analysis — always runs"},
            {"id": "infra_finance_modeler",             "name": "Infrastructure Finance Modeler",     "tier": "T1", "produces": "ICM", "file": "templates/dev-team/agents/finance/infra_finance_modeler.py",  "description": "Infrastructure Cost Model — always runs"},
            {"id": "billing_architect",                 "name": "Billing Architect",                  "tier": "T1", "produces": "BPS", "file": "templates/dev-team/agents/finance/billing_architect.py",      "description": "Billing & Payments Spec — skipped if no billing language in PRD"},
            {"id": "pricing_specialist",                "name": "Pricing Specialist",                 "tier": "T1", "produces": "PRI", "file": "templates/dev-team/agents/finance/pricing_specialist.py",     "description": "Pricing & Revenue model — skipped for internal tool projects"},
            {"id": "financial_statements_modeler",      "name": "Financial Statements Modeler",       "tier": "T1", "produces": "FSR", "file": "templates/dev-team/agents/finance/financial_statements.py",  "description": "Financial Statements Report — always runs"},
            {"id": "strategic_corp_finance_specialist", "name": "Strategic Corporate Finance",        "tier": "T1", "produces": "SCF", "file": "templates/dev-team/agents/finance/strategic_corp_finance.py","description": "Strategic Corporate Finance — always runs last"},
        ],
    },
    "sme": {
        "label":   "SME Group",

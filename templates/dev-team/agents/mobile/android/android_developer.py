...
def run_android_implementation(context: dict, muxd_path: str, prd_path: str) -> tuple:
    # ── Smart extraction: load relevant sections for android_dev ──
    ctx = load_agent_context(
        context=context,
        consumer="android_dev",
        artifact_types=["MUXD", "PRD", "MOBILE_TEST_PLAN"],
...
""",
    ...
    on_artifact_saved(context, "AIR", air_path)

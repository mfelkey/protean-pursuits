...
def run_mobile_scalability_review(context: dict, muxd_path: str,
    ...
    # ── Smart extraction: load relevant sections for mobile_scale ──
    ctx = load_agent_context(
        context=context,
        consumer="mobile_scale",
        artifact_types=["MUXD", "IIR", "AIR", "RN_GUIDE", "MDIR"],
...
""",
    ...
    on_artifact_saved(context, "MOBILE_SAR", msar_path)

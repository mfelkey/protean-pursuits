...
def run_mobile_penetration_test(context: dict, srr_path: str,
    ...
    # ── Smart extraction: load relevant sections for mobile_pen_test ──
    ctx = load_agent_context(
        context=context,
        consumer="mobile_pen_test",
        artifact_types=["SRR", "IIR", "AIR", "RN_GUIDE", "MDIR"],
...
""",
    ...
    on_artifact_saved(context, "MOBILE_PTR", mptr_path)

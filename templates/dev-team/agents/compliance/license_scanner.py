...
def run_license_scan(context: dict, bir_path: str = None,
    ...
    # ── Smart extraction: load relevant sections for license_scan ──
    ctx = load_agent_context(
        context=context,
        consumer="license_scan",
        artifact_types=["PRD", "BIR", "FIR", "DIR", "DSKR", "IIR", "AIR", "RN_GUIDE"],
...
""",
    ...
    on_artifact_saved(context, "LCR", lcr_path)
